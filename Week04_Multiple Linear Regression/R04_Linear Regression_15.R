...
plot(forward_model$anova$AIC, pch = 17, cex=2, main = "AIC Decrease (Forward Selection)", 
     xlab = "Number of Steps", ylab = "AIC")
text(forward_model$anova$AIC, forward_model$anova$Step, cex=1, pos=3, col="blue")

# 변수선택 2: 후방소거법
backward_model <- step(full_model, scope = list(upper = as.formula(tmp_xy), lower = Price ~ 1), 
...
plot(backward_model$anova$AIC, pch = 15, cex=2, main = "AIC Decrease (Backward Selection)", 
     xlab = "Number of Steps", ylab = "AIC")
...
plot(stepwise_model$anova$AIC, pch = 19, cex=2, main = "AIC Decrease (Stepwise Selection)", 
     xlab = "Number of Steps", ylab = "AIC")
